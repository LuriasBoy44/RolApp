...
public class CardActivity extends AppCompatActivity {
    ...
    private String getSkill()
    {
        String [] arraySkills ={"Siempre evita el primer ataque",
                                ...
                                "Puedes atacar por segunda si esta en desventaja numérica",
                                "Devuelve los efectos de habilidades",
                                "Evita que bajen las caracteristicas ",
                                "Invoca clima que sube velocidad + 1 todos los tipo Piedra",
                                "Invoca clima que sube velocidad + 1 todos los tipo Papel",
                                "Invoca clima que sube velocidad + 1 todos los tipo Tijera",
                                "Atrae ataques de tipo Piedra",
                                "Atrae ataques de tipo Papel",
                                "Atrae ataques de tipo Tijera",
                                "Resta velocidad -1 al rival que al rival",
                                ...
                                "Sube el Defensa +1 al hacer daño a tipo Piedra.",
                                "Sube el Defensa +1 al hacer daño a tipo Papel.",
                                "Sube el Defensa +1 al hacer daño a tipo Tijera.",
